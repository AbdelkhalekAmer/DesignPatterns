...
{
    public class OfficeDesktopComputer : DesktopComputerBuilder
    {
        ...
        {
            WithGraphicsCard(GraphicsCardManufacturerEnum.Intel, 2048);
        }

        protected override void BuildHardDisk()
        {
            WithHardDisk(HardDiskTypeEnum.SSD, 256);
        }
        ...
        {
            WithProcessor("Intel Core i5", 2.5, 4);
        }

        protected override void BuildRAM()
        {
            WithRAM(RAMTypeEnum.DDR3, 8);
        }
    }
}
